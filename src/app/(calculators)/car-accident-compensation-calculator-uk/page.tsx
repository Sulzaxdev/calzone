...
export default function CarAccidentCompCalculator() {
    ...
    const exportPDF = async () => {
        ...
        try {
            ...
            pdf.setFontSize(20);
            pdf.text("UK Car Accident Compensation Estimate", 15, 15);
            pdf.setFontSize(10);
            pdf.setTextColor(100);
            pdf.text(`Generated on: ${new Date().toLocaleDateString()}`, 15, 22);
            pdf.text(`Note: This is an unverified estimate for educational purposes, not legal advice.`, 15, 28);
            pdf.addImage(imgData, "PNG", 15, 36, pdfWidth - 30, pdfHeight - 30);
            pdf.save("Car-Accident-Comp-Estimate.pdf");
        } catch (error) {
