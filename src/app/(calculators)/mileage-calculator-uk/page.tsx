...
export default function MileageCalculator() {
    ...
    const exportPDF = async () => {
        ...
        try {
            ...
            pdf.setFontSize(20);
            pdf.text("Mileage Claim Report", 15, 15);
            pdf.setFontSize(10);
            pdf.setTextColor(100);
            pdf.text(`Generated on: ${new Date().toLocaleDateString()}`, 15, 22);
            pdf.text(`Total Miles: ${miles} @ ${rate}p/mile`, 15, 30);
            pdf.addImage(imgData, "PNG", 15, 40, pdfWidth - 30, pdfHeight - 30);
            pdf.save("Mileage-Claim.pdf");
        } catch (err) {
